...
#define SNAP_ITLB		KERNEL_ENTER_EVENT(4)
#define SNAP_DTLB_LD		KERNEL_ENTER_EVENT(5)
#define SNAP_DTLB_ST		KERNEL_ENTER_EVENT(6)
#define SNAP_PROTV		KERNEL_ENTER_EVENT(7)
...
#define SNAP_TLB_FLUSH_ALL	CUSTOM_EVENT(2)
...
enum arc_event {
	...
	ITLB = SNAP_ITLB,
	DITLB_Miss_ld = SNAP_DTLB_LD,
	DTLB_Miss_st = SNAP_DTLB_ST,
	ProtV = SNAP_PROTV,
	TLB_slow = SNAP_UMC,
